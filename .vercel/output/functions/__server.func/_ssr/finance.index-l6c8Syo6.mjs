...
import { A as AppShell, C as Card, i as inr } from "./AppShell-9xLAHItq.mjs";
...
function Finance() {
  ...
  const filteredCommissions = commissionEntries.filter((entry) => inPeriod(entry.paymentDate, period, now));
  const ptRevenue = paid.filter((payment) => payment.category === "Personal Training").reduce((sum, payment) => sum + payment.amount, 0);
  const ptCommission = filteredCommissions.reduce((sum, entry) => sum + (entry.payoutStatus === "Refunded" ? 0 : entry.commissionAmount), 0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { title: "Finance", description: "Collections, dues, refunds, and transaction reporting.", actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-label", children: "PT Commission" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-3xl font-black text-primary", children: inr(ptCommission) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 text-xs text-muted-foreground", children: [
          "from ",
          inr(ptRevenue),
          " PT revenue"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "mb-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-56", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RevenueBars, { data: chart }) })
    ] }),
...
function RevenueBars({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full items-end gap-3 pt-4", children: data.map((item) => {
    const height = Math.max(12, Math.round(item.value / max * 100));
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full min-w-0 flex-1 flex-col justify-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-t-md bg-primary transition-[height]", style: {
        height: `${height}%`
      }, title: `${item.month}: ${inr(item.value)}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-center text-[11px] text-muted-foreground", children: item.month })
    ] }, item.month);
  }) });
}
export {
