...
import { A as AppShell, C as Card, b as initials, c as colorFromName, i as inr, d as dmy } from "./AppShell-9xLAHItq.mjs";
import { R as Route$c, u as useApp, g as getTrainerCommissionEntries } from "./router-Dgpn6rjq.mjs";
...
function StaffDetail() {
  ...
  const commissions = getTrainerCommissionEntries(payments, members, staff, payroll).filter((entry) => entry.staffId === person.id);
  const pendingCommission = commissions.filter((entry) => entry.payoutStatus === "Pending").reduce((sum, entry) => sum + entry.commissionAmount, 0);
  const paidCommission = commissions.filter((entry) => entry.payoutStatus === "Paid").reduce((sum, entry) => sum + entry.commissionAmount, 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { title: "Staff profile", description: `${person.role} - joined ${dmy(person.joined)}`, actions: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-label", children: "Pending PT" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 font-bold text-primary", children: inr(pendingCommission) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-label", children: "Paid PT" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 font-bold text-emerald-400", children: inr(paidCommission) })
      ] })
    ] }),
    ...
    person.role === "Trainer" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "mb-5 !p-0 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-bold", children: "Personal Training commission" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "Auto-calculated from PT payments assigned to this trainer." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-x-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "data-table", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: commissions.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: dmy(entry.paymentDate) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: inr(entry.netAmount) }),
        ...
        !commissions.length && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 text-center text-sm text-muted-foreground", children: "No PT commission assigned yet." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
